...
describe('buildSwishLink', () => {
  ...
  it('encodes amount 24000 minor → 240 (integer, not string)', () => {
  ...
  it('rounds 590.14 SEK (59014 minor) up to 591', () => {
    const payload = decodeSwishLink(buildSwishLink({ ...baseOpts, amountMinor: 59014 }));
    expect(payload.amount.value).toBe(591);
  });
