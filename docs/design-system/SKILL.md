...
- `README.md` — full system: voice, visual foundations, iconography, anti-patterns
- `colors_and_type.css` — drop-in token + semantic style layer
- `preview/` — design-tab cards (color, type, spacing, components, brand)
- `ui_kits/app/` — mobile app components and 5 reference screens
- `ui_kits/marketing/` — marketing site reference
- `assets/` — wordmark SVGs (light + dark)
